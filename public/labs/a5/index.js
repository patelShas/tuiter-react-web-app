...
console.log("Arrays")
console.log(`(${numberArray1.length}) [${numberArray1.toString()}]`)
console.log(`(${stringArray1.length}) [${stringArray1.toString()}]`)
console.log(`(${variableArray1.length}) [${variableArray1.toString()}]`)
